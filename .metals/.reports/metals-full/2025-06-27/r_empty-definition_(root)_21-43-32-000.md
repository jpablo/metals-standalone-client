...
non-local guesses:
	 -io/circe/processMessages.
	 -io/circe/processMessages#
	 -io/circe/processMessages().
	 -io/circe/parser/processMessages.
	 -io/circe/parser/processMessages#
	 -io/circe/parser/processMessages().
	 -io/circe/syntax/processMessages.
	 -io/circe/syntax/processMessages#
	 -io/circe/syntax/processMessages().
	 -kyo/processMessages.
	 -kyo/processMessages#
        ...
        for
          ...
          _ <-
            bytesRead match
              ...
              case n  => processMe@@ssages(buffer + new String(bytes, 0, n, StandardCharsets.UTF_8))
        yield ()
